...
namespace Things
{
    public class ResourceDropBehavior : MonoBehaviour, IWorldItemCollector
    {
        ...
        private DropTweenCase dropTweenCase;
        ...
        public virtual void OnObjectPicked(IResourcePicker target, bool playAnimation = false)
        {
            ...
            if (playAnimation)
            {
                dropTweenCase = new DropTweenCase(transform, target.SnappingTransform, new Vector3(0, 1, 0), Vector3.zero);
