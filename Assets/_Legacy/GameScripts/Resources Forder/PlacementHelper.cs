...
namespace Things
{
    ...
    public class PlacementHelper : MonoBehaviour
    {
        ...
        public void FindChunk()
        {
            ...
            var tiles = FindObjectsByType<GroundTileBehavior>(FindObjectsInactive.Exclude, FindObjectsSortMode.None);
        ...
        {
            var helpers = FindObjectsByType<PlacementHelper>(FindObjectsInactive.Exclude, FindObjectsSortMode.None);
        ...
        {
            PlacementHelper[] helpers = FindObjectsByType<PlacementHelper>(FindObjectsInactive.Exclude, FindObjectsSortMode.None);
