...
namespace Things
{
    public abstract class LevelEditorBase : EditorWindow
    {
        ...
        public static string GetThingsath()
        {
...
// Changelog
// v 1.4
// â€¢ Make restraining window content height into separate setting
// â€¢ Make all useful methods static
// â€¢ Added callbacks to LevelsHandler
// â€¢ Fixed IndexChangeWindow in LevelsHandler
// â€¢ Added more useful stuff to LevelEditorBase
// v 1.3
// â€¢ Fixed styles initialization in our custom list
// â€¢ Reordered some methods
// v 1.2
// â€¢ Replaced Reordable list with our CustomList
// v 1.1
// â€¢ Added global validation support
// â€¢ Changed validation
