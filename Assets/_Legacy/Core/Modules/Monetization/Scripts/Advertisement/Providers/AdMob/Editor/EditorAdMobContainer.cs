...
namespace Things
{
    public class EditorAdMobContainer : EditorAdsContainer
    {
        ...
        private void DrawAddUnitsSection()
        {
            ...
            DrawIdProperty(androidBannerIdProperty, Things.AdMobContainer.ANDROID_BANNER_TEST_ID);
            DrawIdProperty(iOSBannerIdProperty, Things.AdMobContainer.IOS_BANNER_TEST_ID);
            ...
            DrawIdProperty(androidInterstitialIdProperty, Things.AdMobContainer.ANDROID_INTERSTITIAL_TEST_ID);
            DrawIdProperty(iOSInterstitialIdProperty, Things.AdMobContainer.IOS_INTERSTITIAL_TEST_ID);

            EditorGUILayout.LabelField("Rewarded Video ID", groupStyle);
            DrawIdProperty(androidRewardedVideoIdProperty, Things.AdMobContainer.ANDROID_REWARDED_VIDEO_TEST_ID);
            DrawIdProperty(iOSRewardedVideoIdProperty, Things.AdMobContainer.IOS_REWARDED_VIDEO_TEST_ID);
            ...
            {
                DrawIdProperty(androidAppOpenAdIDProperty, Things.AdMobContainer.ANDROID_OPEN_TEST_ID);
                DrawIdProperty(iosAppOpenAdIDProperty, Things.AdMobContainer.IOS_OPEN_TEST_ID);
            }
            ...
            {
                androidBannerIdProperty.stringValue = Things.AdMobContainer.ANDROID_BANNER_TEST_ID;
                iOSBannerIdProperty.stringValue = Things.AdMobContainer.IOS_BANNER_TEST_ID;

                androidInterstitialIdProperty.stringValue = Things.AdMobContainer.ANDROID_INTERSTITIAL_TEST_ID;
                iOSInterstitialIdProperty.stringValue = Things.AdMobContainer.IOS_INTERSTITIAL_TEST_ID;

                androidRewardedVideoIdProperty.stringValue = Things.AdMobContainer.ANDROID_REWARDED_VIDEO_TEST_ID;
                iOSRewardedVideoIdProperty.stringValue = Things.AdMobContainer.IOS_REWARDED_VIDEO_TEST_ID;

                androidAppOpenAdIDProperty.stringValue = Things.AdMobContainer.ANDROID_OPEN_TEST_ID;
                iosAppOpenAdIDProperty.stringValue = Things.AdMobContainer.IOS_OPEN_TEST_ID;
            }
        }
