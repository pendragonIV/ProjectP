...
// Changelog
// v1.4.2
// â€¢ Added EnableBanner, DisableBanner methods
// v1.4.1
// â€¢ Added ironSource (Unity LevelPlay) ad provider
// v1.4
// â€¢ Admob v9.0.0 support
// â€¢ Better naming and code cleanup
// â€¢ Ads callbacks replaced with simplified ones (AdLoaded, AdDisplayed, AdClosed)
// â€¢ Removed ShowInterstitial, ShowRewardedVideo, ShowBanner methods with provider type parameter
// â€¢ Added optional bool parameter to ShowInterstitial method. Allows to show interstitial even if conditions aren't met
// v1.3
// â€¢ Admob v8.1.0 support
// â€¢ Removed IronSource provider
// v1.2.1
// â€¢ Some fixes in IronSourse provider
// â€¢ Some fixes in Admob provider
// â€¢ New interface in Admob provider
// â€¢ Added Build Preprocessing for Admob 
// v1.2
// â€¢ Added IronSource provider
// v1.1f3
// â€¢ GDPR style rework
// â€¢ Rewarded video error message
// â€¢ Removed GDPR check in AdMob module
// v1.1f2
// â€¢ GDPR init bug fixed
// v1.1
// â€¢ Added first ad loader
// â€¢ Moved IAP check to AdsManager script
// v1.0
// â€¢ Added documentation
// v0.3
// â€¢ Unity Ads fixed
// v0.2
// â€¢ Bug fix
