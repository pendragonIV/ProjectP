...
namespace Things
{
    ...
    public static class IAPManager
    {
        ...
        public static void OnPurchaseFailed(ProductKeyType productKey, Things.PurchaseFailureReason failureReason)
        {
        ...
        public delegate void ProductFailCallback(ProductKeyType productKeyType, Things.PurchaseFailureReason failureReason);
    }
}
