...
namespace Things
{
    public static class DefineSettings
    {
        ...
        public static readonly RegisteredDefine[] STATIC_REGISTERED_DEFINES = new RegisteredDefine[]
        {
            ...
            // Core
            new RegisteredDefine("MODULE_MONETIZATION", "Things.Monetization"),
            new RegisteredDefine("MODULE_IAP", "UnityEngine.Purchasing.UnityPurchasing"),
            new RegisteredDefine("MODULE_POWERUPS", "Things.PUController"),
            new RegisteredDefine("MODULE_HAPTIC", "Things.Haptic"),
            new RegisteredDefine("MODULE_CURVE", "Things.CurvatureManager"),
