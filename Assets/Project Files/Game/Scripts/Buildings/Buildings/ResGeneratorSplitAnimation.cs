...
namespace Watermelon
{
    public class ResGeneratorSplitAnimation : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            flyingResTransform1 = CurrencyController.GetCurrency(generatorRef.ResourceType).Data.FlyingResPool.GetPooledObject().transform;
            flyingResTransform2 = CurrencyController.GetCurrency(generatorRef.ResourceType).Data.FlyingResPool.GetPooledObject().transform;
